...
Probe file: linear_probe_last.json   (MATCHED-EPOCH corpus, not the released best.pt one)
...
==============================================================
law-scope cells with >=3 seed-matched arms : 931
SEM(paired)/SEM(independent) median        : 0.535  (independent overstates in 86%)
inside crossing bracket (no prediction)    : 93
unresolved (|readout| <= 2.0 SEM)            : 353
...
THRESHOLD SENSITIVITY
  >1.0 SEM :  499/630  = 79.2%  [75.9, 82.2]
  >1.5 SEM :  453/550  = 82.4%  [79.0, 85.3]
...
WHAT THE READOUT DEPENDS ON (variance explained)
  baseline accuracy alone (5-point bins) : R^2 = 0.298
  ...
  residual SD at fixed baseline          : 1.73 points
