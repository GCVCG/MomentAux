...
\citep{romero2015fitnets} and deep supervision; HOG
...
\citep{touvron2021deit}, soft convolutional biases,
compact hybrid designs, and auxiliary
self-supervision. That the deficit
...
the Scattering Vision Transformer  performs
spectral decomposition with dual-tree complex wavelets inside the token
mixer, and FViT  adds a \emph{learnable} Gabor filter
...
Fixed spectral filters in the forward path
  \citep{bruna2013scattering,luan2018gaborcnn}
  & \pmark & \xmark & \xmark & \xmark & \xmark \\
Auxiliary and distillation targets
  \citep{romero2015fitnets,wei2022maskfeat}
...
manufacture illusory progress,
and reproducibility in ML remains fragile. We adopt
