...
A single champion setting transplants without retuning: ResNet-18, -34
and -50 land $+4.3$, $+4.0$ and $+3.9$ at the same cell; the new depth
...
five of them with the same signature: the prior still improves frozen-feature
