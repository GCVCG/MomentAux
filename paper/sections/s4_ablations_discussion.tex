...
optimisation on backbones whose baselines collapse.
...
descriptor recovers about half. Within each block rows are sorted by the
10\% gain, descending; \up{} marks columns where higher is better.}
\label{tab:controls}
...
verbatim. Rows are ordered by backbone family and then by data regime,
convolutional first, attention next, initialisation-dependent cases last.}
\label{tab:guide}
\centering\scriptsize
\setlength{\tabcolsep}{2.6pt}
\resizebox{\columnwidth}{!}{%
