...
over 8{,}827 runs, each with a retained run record.
...
511 cells where measurement uncertainty allows it to be tested at all, and
...
\citep{touvron2021deit}, hierarchical and convolutional inductive biases
\citep{liu2021swin}, and auxiliary self-supervised objectives, of which
the fixed target studied here is one. That the deficit
...
\citep{raghu2021vision}. Our contribution
...
a scattering-based transformer \citep{patro2023scattering} performs
