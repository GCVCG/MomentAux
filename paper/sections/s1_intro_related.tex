...
resolutions from $32$ to $224$\,px, and 2{,}874 experimental cells. The
...
\begin{enumerate}
  ...
  \item \textbf{The grid} (Section~\ref{sec:grid}): $2{,}874$ cells
...
linear-evaluation gap on frozen features: cheap enough for 2{,}874 cells,
