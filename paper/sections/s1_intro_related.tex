...
In one line, what the grid says: measure each source's currency alone and
the result of fusing them is known in advance
(Section~\ref{sec:fusion}); never pour a shaping prior into a strong
initialization, because the tax scales with what that initialization was
worth (Section~\ref{sec:taxsub}); modern augmentation does not replace
