...
our comparison is organised: hand-crafted structure placed in the forward
...
checkpoint someone else produced, and neither normalises by training
...
which is what makes cost normalisation and the stacking question
answerable at all.
...
Table~\ref{tab:gap} summarises the position. Each column is a property
...
on top of a pretrained initialisation is precisely the fusion question,
