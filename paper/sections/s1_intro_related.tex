...
instrument, one frozen training recipe, data subsets whose per-class image
indices are drawn once and checked into version control so that every run
trains on byte-identical images (we call these \emph{committed} subsets
throughout), and a numerically pinned bank of Gabor and moment
